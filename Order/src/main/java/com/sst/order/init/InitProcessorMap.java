package com.sst.order.init;

import com.sst.enumeration.order.ProcessReqEnum;
import com.sst.order.annotation.InjectProcessors;
import com.sst.order.annotation.PackageScan;
import com.sst.order.engine.ProcessEngine;
import com.sst.order.processor.Processor;
 ...
 */
@Component
@PackageScan("com.sst.order.engine.ProcessEngine")
