package com.sst.user.dao;

import com.sst.entity.user.*;
import com.sst.req.user.LocationUpdateReq;
import com.sst.req.user.RoleMenuReq;
import com.sst.req.user.RolePermissionReq;
import com.sst.req.user.UserQueryReq;
